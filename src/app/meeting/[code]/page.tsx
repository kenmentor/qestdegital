...
function CaptionOverlay({ isCaptionsEnabled }: { isCaptionsEnabled: boolean }) {
  return (
    <AnimatePresence>
      {isCaptionsEnabled && (
        <motion.div
...
export default function MeetingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative">
      ...
      {/* Main speaker tile */}
      <div className="h-screen flex flex-col items-center justify-center px-4 pb-36 sm:pb-28">
        <SpeakerTile
          userName={userName}
          connectionState={connectionState}
          selectedLanguage={selectedLanguage}
      ...
      {/* Bottom overlays */}
      <CaptionOverlay isCaptionsEnabled={isCaptionsEnabled} />
      <ControlBar
        onLeave={handleLeave}
        selectedLanguage={selectedLanguage}
